...
public class BumbperShot extends Command implements Constants.Field, Constants.Shooter, Constants.Indexer {
    ...
    public BumbperShot(Shooter shooter, Indexer indexer, DriveTrain driveTrain) {
    ...
    public void initialize() {
        ...
        shootAngleSpeed = new AngleSpeed(4.8, 160); //changed from 4.7
