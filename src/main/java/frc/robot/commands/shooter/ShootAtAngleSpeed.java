...
public class ShootAtAngleSpeed extends Command implements Constants.Field, Constants.Shooter, Constants.Indexer {
    ...
    private AngleSpeed angleSpeed;

    public ShootAtAngleSpeed(Shooter shooter, Indexer indexer, DriveTrain driveTrain, AngleSpeed angleSpeed) {
    ...
    public void initialize() {
        ...
        shooter.aim(angleSpeed.getAngle());
        shooter.setSpeed(angleSpeed.getSpeed());
